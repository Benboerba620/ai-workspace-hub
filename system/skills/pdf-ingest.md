...
1. 检查 Python：`python --version`（或 `python3 --version`）。
...
3. 转换：
   ```bash
   python system/scripts/pdf_to_md.py <input.pdf> <output.md>
   ```
...
```bash
python system/scripts/pdf_to_md.py inbox/sample-ai-workspace.pdf inbox/sample-ai-workspace.md
```
